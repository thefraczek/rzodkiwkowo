        ...
        <>
          ...
          <div className='fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white rounded-t-2xl shadow-2xl' style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
            ...
            <div className='px-4 pb-4 space-y-4'>
              ...
              <button onClick={() => { supabase.auth.signOut(); setOpen(false) }} className='w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-red-500 active:bg-red-50 transition-colors'>
